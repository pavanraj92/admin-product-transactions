...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.transactions.index') }}">Transaction Details</a>
    </li>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <p>{!! config('transaction.constants.transactionStatusLabel.' . $transaction->status, 'N/A') !!}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="card mb-3">
                                    <div class="card-header bg-primary">
                                        <h5 class="mb-0 text-white font-bold">Order Details</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <p>{{ $transaction?->order?->order_date
                                                        ? $transaction?->order?->order_date->format(config('GET.admin_date_time_format') ?? 'Y-m-d H:i:s')
                                                        : '—' }}
                                                    </p>
                                                </div>
                                            </div>
